...
function Navbar() {
  ...
  return (
    <Menu inverted color='blue' stackable size='massive' style={{borderRadius: 0}}>
      <Container>
        <Menu.Item header>BudgetApp</Menu.Item>
        <Menu.Item as={Link} exact='true' to="/">Home</Menu.Item>
        <Menu.Item as={Link} to="/admin" style={adminPageStyle()}>Admin Console</Menu.Item>
        <Menu.Item as={Link} to="/user" style={userPageStyle()}>Budgets</Menu.Item>
